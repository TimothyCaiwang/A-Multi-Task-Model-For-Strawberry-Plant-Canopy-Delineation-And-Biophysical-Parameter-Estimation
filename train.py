...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        mean_loss, lr, loss_value_all = utils.train_one_epoch(model, optimizer, train_data_loader,
                                                              device, epoch, print_freq=50,
                                                              warmup=True, scaler=scaler)
        loss_all_epochs.append(loss_value_all)
    ...
    np.save('loss_record.npy', loss_all_epochs)
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='E:/Caiwang_ZHENG/Strawberry_Dry_Biomass_Prediction_2021_To_2022/labelme_test/mydata_to_coco_test/drone/data_with_biomass/coco/', help='dataset')
    # 检测目标类别数(不包含背景)
